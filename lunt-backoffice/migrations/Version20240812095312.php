 ...
 */
final class Version20240812095312 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dewey (id INT AUTO_INCREMENT NOT NULL, parent_id INT DEFAULT NULL, code VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, cree_le DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', edite_le DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_C685090E77153098 (code), INDEX IDX_C685090E727ACA70 (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE discipline (id INT AUTO_INCREMENT NOT NULL, parent_id INT DEFAULT NULL, code VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, cree_le DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', edite_le DATETIME DEFAULT NULL, INDEX IDX_75BEEE3F727ACA70 (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE dossier (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, parent_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, cree_le DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', edite_le DATETIME DEFAULT NULL, INDEX IDX_3D48E037A76ED395 (user_id), INDEX IDX_3D48E037727ACA70 (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE niveau (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, cree_le DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', edite_le DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE notice (id INT AUTO_INCREMENT NOT NULL, createur_id INT DEFAULT NULL, validateur_id INT DEFAULT NULL, droit_id INT NOT NULL, codewey_id INT DEFAULT NULL, specialite_id INT NOT NULL, repertoire_id INT DEFAULT NULL, uuid BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', titre VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, label VARCHAR(255) DEFAULT NULL, vignette VARCHAR(255) DEFAULT NULL, dure_exec VARCHAR(255) DEFAULT NULL, dure_appr VARCHAR(255) DEFAULT NULL, objectif VARCHAR(255) DEFAULT NULL, prop_user JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', user_lang JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', ress_lang JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', ress_size INT DEFAULT NULL, ress_date DATETIME NOT NULL, publie_le DATETIME DEFAULT NULL, etat INT DEFAULT NULL, export_oai TINYINT(1) DEFAULT NULL, ress_url VARCHAR(255) NOT NULL, form_eval_url VARCHAR(255) DEFAULT NULL, ress_payant TINYINT(1) NOT NULL, propr_intel TINYINT(1) NOT NULL, edit_demande TINYINT(1) DEFAULT NULL, champ_ext1 VARCHAR(255) DEFAULT NULL, champ_ext2 VARCHAR(255) DEFAULT NULL, champ_ext3 VARCHAR(255) DEFAULT NULL, champ_ext4 VARCHAR(255) DEFAULT NULL, champ_ext5 VARCHAR(255) DEFAULT NULL, cree_le DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', edite_le DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_480D45C2D17F50A6 (uuid), INDEX IDX_480D45C273A201E5 (createur_id), INDEX IDX_480D45C2E57AEF2F (validateur_id), INDEX IDX_480D45C25AA93370 (droit_id), INDEX IDX_480D45C21F6D6203 (codewey_id), INDEX IDX_480D45C22195E0F0 (specialite_id), INDEX IDX_480D45C21E61B789 (repertoire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tdocument (id INT AUTO_INCREMENT NOT NULL, code VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, cree_le DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', edite_le DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tpedagogie (id INT AUTO_INCREMENT NOT NULL, code VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, cree_le DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', edite_le DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, group_id INT DEFAULT NULL, untheme_id INT DEFAULT NULL, school_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, email VARCHAR(180) NOT NULL, password VARCHAR(255) DEFAULT NULL, enabled TINYINT(1) DEFAULT NULL, rese_token VARCHAR(255) DEFAULT NULL, token_expires_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', cree_le DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', edite_le DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D649FE54D947 (group_id), INDEX IDX_8D93D6495B6BD772 (untheme_id), INDEX IDX_8D93D649C32A47EE (school_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE notice ADD CONSTRAINT FK_480D45C21E61B789 FOREIGN KEY (repertoire_id) REFERENCES dossier (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE notice DROP FOREIGN KEY FK_480D45C21E61B789');
